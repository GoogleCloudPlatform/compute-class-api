...
// WithDiskCount sets the DiskCount field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the DiskCount field is set to the value of the last call.
func (b *SwapConfigDedicatedLocalSsdProfileApplyConfiguration) WithDiskCount(value int64) *SwapConfigDedicatedLocalSsdProfileApplyConfiguration {
	b.DiskCount = &value
	return b
}
