...
func (b *LRUGenApplyConfiguration) WithEnabled(value bool) *LRUGenApplyConfiguration {
	b.Enabled = &value
	return b
}

// WithMinTtlMs sets the MinTtlMs field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the MinTtlMs field is set to the value of the last call.
func (b *LRUGenApplyConfiguration) WithMinTtlMs(value int32) *LRUGenApplyConfiguration {
	b.MinTtlMs = &value
	return b
}
