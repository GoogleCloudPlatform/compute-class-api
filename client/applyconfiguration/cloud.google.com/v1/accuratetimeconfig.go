...
// WithEnablePtpKvmTimeSync sets the EnablePtpKvmTimeSync field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the EnablePtpKvmTimeSync field is set to the value of the last call.
func (b *AccurateTimeConfigApplyConfiguration) WithEnablePtpKvmTimeSync(value bool) *AccurateTimeConfigApplyConfiguration {
	b.EnablePtpKvmTimeSync = &value
	return b
}
