...
// WithLoggingVariantConfig sets the LoggingVariantConfig field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the LoggingVariantConfig field is set to the value of the last call.
func (b *NodePoolLoggingConfigApplyConfiguration) WithLoggingVariantConfig(value *LoggingVariantConfigApplyConfiguration) *NodePoolLoggingConfigApplyConfiguration {
	b.LoggingVariantConfig = value
	return b
}
