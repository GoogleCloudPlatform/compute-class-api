...
// +kubebuilder:validation:XValidation:rule="self.priorities.all(p1, self.priorities.filter(p2, p1.rank == p2.rank).size() <= 3)", message="No more than 3 priorities can have the same rank"
