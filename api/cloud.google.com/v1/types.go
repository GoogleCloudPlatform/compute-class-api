...
type MigrationStatus struct {
	...
	// +optional
	ConfigDrift *ConfigDriftStatus `json:"configDrift,omitempty" protobuf:"bytes,1,opt,name=configDrift"`
}
...
type ConfigDriftStatus struct {
	...
	// +optional
	// +kubebuilder:validation:Minimum=0
	CurrentNodes *int `json:"currentNodes,omitempty" protobuf:"bytes,1,opt,name=currentNodes"`
	...
	// +optional
	// +kubebuilder:validation:Minimum=0
	DriftedNodes *int `json:"driftedNodes,omitempty" protobuf:"bytes,2,opt,name=driftedNodes"`
	...
	// +optional
	// +kubebuilder:validation:Minimum=0
	MigratingNodes *int `json:"migratingNodes,omitempty" protobuf:"bytes,3,opt,name=migratingNodes"`
	...
	BlockedNodes []BlockedNodesInfo `json:"blockedNodes,omitempty" protobuf:"bytes,4,rep,name=blockedNodes"`

	// MeasuredAt represents the timestamp at which the reported information was measured.
	// +optional
	MeasuredAt *metav1.Time `json:"measuredAt,omitempty" protobuf:"bytes,5,opt,name=measuredAt"`
}
